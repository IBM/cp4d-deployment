...
data "template_file" "ibmcpd-cr-nfs-file" {
  template = file("../cpd4_module/ibmcpd-cr-nfs.tpl.yaml")
  vars = {
    NAMESPACE = var.cpd-namespace
  }
}

data "template_file" "ibmcpd-cr-pwx-ocs-file" {
  template = file("../cpd4_module/ibmcpd-cr-pwx-ocs.tpl.yaml")
  vars = {
    NAMESPACE      = var.cpd-namespace
...
data "template_file" "cpdoperandrequestfile" {
  template = file("../cpd4_module/cpd-platform-operator-operandrequest.tpl.yaml")
  vars = {
    CPDNAMESPACE = var.cpd-namespace
  }
}

data "template_file" "cpdsubfile" {
  template = file("../cpd4_module/cpd-platform-operator-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "wslsubfile" {
  template = file("../cpd4_module/wsl-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "wmlsubfile" {
  template = file("../cpd4_module/wml-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "wossubfile" {
  template = file("../cpd4_module/wos-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "spsssubfile" {
  template = file("../cpd4_module/spss-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "cdesubfile" {
  template = file("../cpd4_module/cde-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "dodssubfile" {
  template = file("../cpd4_module/dods-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "sparksubfile" {
  template = file("../cpd4_module/spark-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "dvsubfile" {
  template = file("../cpd4_module/dv-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "bigsqlsubfile" {
  template = file("../cpd4_module/bigsql-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "casubfile" {
  template = file("../cpd4_module/ca-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "db2usubfile" {
  template = file("../cpd4_module/db2u-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "db2oltpsubfile" {
  template = file("../cpd4_module/db2oltp-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "db2whsubfile" {
  template = file("../cpd4_module/db2wh-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "wkcsubfile" {
  template = file("../cpd4_module/wkc-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}

data "template_file" "dssubfile" {
  template = file("../cpd4_module/ds-sub.tpl.yaml")
  vars = {
    OPERATORNAMESPACE = var.operator-namespace
  }
}
