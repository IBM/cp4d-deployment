locals {
  ...
  datarefinery-condition = (var.data-refinery == "yes" || var.wsl == "yes" || var.wkc == "yes" ? "yes" : "no")
  db2uoperator-condition = (var.db2uoperator == "yes" || var.db2wh == "yes" || var.db2oltp == "yes" || var.wkc == "yes" || var.dv == "yes" || var.bigsql == "yes" ? "yes" : "no")
  dmc-condition          = (var.dmc == "yes" || var.dv == "yes" || var.bigsql == "yes" ? "yes" : "no")
  db2aaservice-condition = (var.db2aaservice == "yes" || var.wkc == "yes" || var.db2oltp == "yes" ? "yes" : "no")
}
...
resource "null_resource" "install-ccs" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "wget ${local.cpd-repo-url}/ibm-ccs-1.0.0.tgz",
      ...
      "./install-ccs-operator.sh ibm-ccs-1.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-data-refinery" {
  count = local.datarefinery-condition == "yes" ? 1 : 0
  triggers = {
    bootnode_ip_address   = local.bootnode_ip_address
    username              = var.admin-username
    private_key_file_path = var.ssh-private-key-file-path
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "wget ${local.cpd-repo-url}/ibm-datarefinery-1.0.0.tgz",
      ...
      "./install-data-refinery-operator.sh ibm-datarefinery-1.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-db2uoperator" {
  count = local.db2uoperator-condition == "yes" ? 1 : 0
  triggers = {
    bootnode_ip_address   = local.bootnode_ip_address
    username              = var.admin-username
    private_key_file_path = var.ssh-private-key-file-path
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package. 
      ## Db2u Operator 
      "wget ${local.cpd-repo-url}/ibm-db2uoperator-4.0.0-3731.2407.tgz",
      ...
      "./install-db2u-operator.sh ibm-db2uoperator-4.0.0-3731.2407.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-dmc" {
  count = local.dmc-condition == "yes" ? 1 : 0
  triggers = {
    bootnode_ip_address   = local.bootnode_ip_address
    username              = var.admin-username
    private_key_file_path = var.ssh-private-key-file-path
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      ## DMC Operator 
      "wget ${local.cpd-repo-url}/ibm-dmc-4.0.0.tgz",
      ...
      "./install-dmc-operator.sh ibm-dmc-4.0.0.tgz ${var.operator-namespace} ${local.cpd-storageclass}",
      ...
      "${local.cpd-common-files}/check-cr-status.sh dmcaddon dmcaddon-cr ${var.cpd-namespace} dmcStatus",
...
resource "null_resource" "install-db2aaservice" {
  count = local.db2aaservice-condition == "yes" ? 1 : 0
  triggers = {
    bootnode_ip_address   = local.bootnode_ip_address
    username              = var.admin-username
    private_key_file_path = var.ssh-private-key-file-path
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      ## Db2asaservice 
      "wget ${local.cpd-repo-url}/ibm-db2aaservice-4.0.0.tgz",
      ...
      "./install-db2aaservice-operator.sh ibm-db2aaservice-4.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-wsl" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "wget ${local.cpd-repo-url}/ibm-wsl-2.0.0.tgz",
      ...
      "./install-wsl-operator.sh ibm-wsl-2.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-aiopenscale" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package. 
      "wget ${local.cpd-repo-url}/ibm-watson-openscale-2.0.0.tgz",
      ...
      "./install-openscale-operator.sh ibm-watson-openscale-2.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-spss" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package. 
      "wget ${local.cpd-repo-url}/ibm-spss-1.0.0.tgz",
      ...
      "./install-spss-operator.sh ibm-spss-1.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-wml" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package. 
      "wget ${local.cpd-repo-url}/ibm-wml-cpd-4.0.0.tgz",
      ...
      "./install-wml-operator.sh ibm-wml-cpd-4.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-cde" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package.
      "wget ${local.cpd-repo-url}/ibm-cde-2.0.0.tgz",
      ...
      "./install-cde-operator.sh ibm-cde-2.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-dods" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "wget ${local.cpd-repo-url}/ibm-dods-4.0.0.tgz",
      ...
      "./install-dods-operator.sh ibm-dods-4.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-spark" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "wget ${local.cpd-repo-url}/ibm-analyticsengine-4.0.0.tgz",
      ...
      "./install-spark-operator.sh ibm-analyticsengine-4.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-dv" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package. 
      ## DV case 
      "wget ${local.cpd-repo-url}/ibm-dv-case-1.7.0.tgz",
      ...
      "./install-dv-operator.sh ibm-dv-case-1.7.0.tgz ${var.operator-namespace}",
      ...
      "./install-dv-cr.sh ibm-dv-case-1.7.0.tgz ${var.cpd-namespace}",
...
resource "null_resource" "install-bigsql" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package. 
      ## bigsql case package 
      "wget ${local.cpd-repo-url}/ibm-bigsql-case-7.2.0.tgz",
      ...
      "./install-bigsql-operator.sh ibm-bigsql-case-7.2.0.tgz ${var.operator-namespace}",
      ...
      "./install-bigsql-cr.sh ibm-bigsql-case-7.2.0.tgz ${var.cpd-namespace}",
...
resource "null_resource" "install-wkc" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package. 
      # ## wkc case package 
      "wget ${local.cpd-repo-url}/ibm-wkc-4.0.0.tgz",

      # ## IIS case package 
      "wget ${local.cpd-repo-url}/ibm-iis-4.0.0.tgz",
      ...
      "./install-wkc-operator.sh ibm-wkc-4.0.0.tgz ${var.operator-namespace}",
      ...
      "./install-wkc-iis-operator.sh ibm-iis-4.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-ca" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package. 	
      "wget ${local.cpd-repo-url}/ibm-cognos-analytics-prod-4.0.0.tgz",
      ...
      "./install-ca-operator.sh ibm-cognos-analytics-prod-4.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-ds" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package. 	
      "wget ${local.cpd-repo-url}/ibm-datastage-4.0.1.tgz",
      ...
      "./install-ds-operator.sh ibm-datastage-4.0.1.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-db2oltp" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package. 	
      "wget ${local.cpd-repo-url}/ibm-db2oltp-4.0.0.tgz",
      ...
      "./install-db2oltp-operator.sh ibm-db2oltp-4.0.0.tgz ${var.operator-namespace}",
...
resource "null_resource" "install-db2wh" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      # Case package. 	
      "wget ${local.cpd-repo-url}/ibm-db2wh-4.0.0.tgz",
