...
bash cpd/scripts/apply-cr.sh ${self.triggers.cpd_workspace} ${var.cpd_version} db2wh ${var.cpd_namespace} ${var.storage_option} ${local.storage_class} ${local.rwo_storage_class}
