...
# ## wkc case package 
curl -s https://${GIT_TOKEN}@raw.github.ibm.com/PrivateCloud-analytics/cpd-case-repo/4.0.0/dev/case-repo-dev/ibm-wkc/4.0.0-416/ibm-wkc-4.0.0-416.tgz -o ibm-wkc-4.0.0-416.tgz

# ## IIS case package 
curl -s https://${GIT_TOKEN}@raw.github.ibm.com/PrivateCloud-analytics/cpd-case-repo/4.0.0/dev/case-repo-dev/ibm-iis/4.0.0-355/ibm-iis-4.0.0-355.tgz -o ibm-iis-4.0.0-355.tgz
...
./install-wkc-operator.sh ibm-wkc-4.0.0-416.tgz ibm-common-services
...
./install-wkc-iis-operator.sh ibm-iis-4.0.0-355.tgz ibm-common-services
