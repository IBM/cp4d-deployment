locals {
  crio_config_data   = base64encode(file("machineconfig/config/crio.conf"))
  limits_config_data = base64encode(file("machineconfig/config/limits.conf"))
  sysctl_config_data = base64encode(file("machineconfig/config/sysctl.conf"))
}
