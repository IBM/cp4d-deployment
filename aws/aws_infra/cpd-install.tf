...
resource "null_resource" "cpd_config" {
    ...
    provisioner "remote-exec" {
        inline = [
            ...
            # "wget https://raw.githubusercontent.com/IBM/cp4d-deployment/master/aws/cpd_module/cpd-linux -O ${local.installerhome}/cpd-linux",
            "wget https://raw.githubusercontent.com/IBM/cp4d-deployment/CPD3.5/aws/cpd_module/cpd-linux -O ${local.installerhome}/cpd-linux",
